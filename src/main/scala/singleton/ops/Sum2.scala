...
trait Func2StaticAux[
    F[P1 <: SingletonTypeExpr, P2 <: SingletonTypeExpr] <: SingletonTypeFunc2[
      P1,
      P2],
    OP[T1, S1 <: T1 with Singleton, T2, S2 <: T2 with Singleton] <: Op2[T1,
                                                                           S1,
                                                                           T2,
                                                                           S2]
] {
  type OpMacro[T1, S1 <: T1 with Singleton, T2, S2 <: T2 with Singleton] =
    OP[T1, S1, T2, S2]
  type Aux[
...
object Sum2 extends Func2StaticAux[Sum2, SumMacro] { //extends SingletonTypeFunc2Static("+") {
  ...
  implicit def impl[
    ...
    op: OpMacro[P1_BaseType, P1_Out, P2_BaseType, P2_Out])
