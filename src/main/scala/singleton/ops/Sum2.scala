...
trait Func2StaticAux[
  ...
  type OpMacro[B, T1, S1 <: T1 with Singleton, T2, S2 <: T2 with Singleton] = OP[B,T1,S1,T2,S2]
  type Aux[
...
new Sum2[P1, P2] with SingletonTypeExprInt {
  ...
  Ret_BaseType,
  Ret_Out <: Ret_BaseType with Singleton
  ](implicit p1 : P1, p2: P2, p1_ret : Extractor.Aux[P1,P1_BaseType,P1_Out], p2_ret : Extractor.Aux[P2,P2_BaseType,P2_Out], op : OpMacro[Int, P1_BaseType, P1_Out, P2_BaseType, P2_Out]) :
  ...
  Ret_BaseType,
  Ret_Out <: Ret_BaseType with Singleton
  ](implicit p1 : P1, p2: P2, p1_ret : Extractor.Aux[P1,P1_BaseType,P1_Out], p2_ret : Extractor.Aux[P2,P2_BaseType,P2_Out], op : OpMacro[Long, P1_BaseType, P1_Out, P2_BaseType, P2_Out]) :
  ...
  Ret_BaseType,
  Ret_Out <: Ret_BaseType with Singleton
  ](implicit p1 : P1, p2: P2, p1_ret : Extractor.Aux[P1,P1_BaseType,P1_Out], p2_ret : ToLong.Aux[P2,P2_BaseType,P2_Out,PM_BaseType,PM_Out], op : OpMacro[Long, P1_BaseType, P1_Out, PM_BaseType, PM_Out]) :
  Aux[P1, P2, op.BaseType, op.Out] with SingletonTypeExprLong = Sum2[P1,P2](p1,p2,op)
  ...
  Ret_BaseType,
  Ret_Out <: Ret_BaseType with Singleton
  ](implicit p1 : P1, p2: P2, p1_ret : ToLong.Aux[P1,P1_BaseType,P1_Out,PM_BaseType,PM_Out], p2_ret : Extractor.Aux[P2,P2_BaseType,P2_Out], op : OpMacro[Long, PM_BaseType, PM_Out, P2_BaseType, P2_Out]) :
  Aux[P1, P2, op.BaseType, op.Out] with SingletonTypeExprLong = Sum2[P1,P2](p1,p2,op)
}
