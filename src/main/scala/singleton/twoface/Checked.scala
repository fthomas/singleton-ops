...
object Checked {
  final class Char[T, Cond[_,_], Param, Msg[_,_]] private(val value : scala.Char) extends AnyVal with TwoFaceAny.Char[T] {
  ...
  final class Int[T, Cond[_,_], Param, Msg[_,_]] private(val value : scala.Int) extends AnyVal with TwoFaceAny.Int[T] {
  ...
  final class Long[T, Cond[_,_], Param, Msg[_,_]] private(val value : scala.Long) extends AnyVal with TwoFaceAny.Long[T] {
  ...
  final class Float[T, Cond[_,_], Param, Msg[_,_]] private(val value : scala.Float) extends AnyVal with TwoFaceAny.Float[T] {
  ...
  final class Double[T, Cond[_,_], Param, Msg[_,_]] private(val value : scala.Double) extends AnyVal with TwoFaceAny.Double[T] {
  ...
  final class String[T, Cond[_,_], Param, Msg[_,_]] private(val value : java.lang.String) extends AnyVal with TwoFaceAny.String[T] {
  ...
  final class Boolean[T, Cond[_,_], Param, Msg[_,_]] private(val value : scala.Boolean) extends AnyVal with TwoFaceAny.Boolean[T] {
