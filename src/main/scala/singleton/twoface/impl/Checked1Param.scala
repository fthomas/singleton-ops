...
trait Checked1Param[Cond[_,_], Msg[_,_], Face, ParamFace] extends Any with TwoFaceAny[Face] {
...
//    : PrimChk[T0, Param] = macro Builder.Macro.fromTF[PrimChk[_,_], SecChk[_,_], Cond[_,_], Msg[_,_]]
    ...
    implicit def fromTF[T0 <: Face, Param <: ParamFace](value : TwoFaceAny[Face]{type T = T0})(implicit param : AcceptNonLiteral[Id[Param]])
    : PrimChk[T0, Param] = macro Builder.Macro.fromTF[PrimChk[_,_], SecChk[_,_], Cond[_,_], Msg[_,_]]
    ////////////////////////////////////////////////////////////////////////////////////////
  }
  ...
  object Builder {
    final class Macro(val c: whitebox.Context) extends GeneralMacros {
      ...
      def fromOpImpl[T, Param, PrimChk, SecChk, Cond, Msg](value : c.Tree, param : c.Tree)(
        implicit
        t : c.WeakTypeTag[T], p : c.WeakTypeTag[Param], primChk : c.WeakTypeTag[PrimChk], secChk : c.WeakTypeTag[SecChk], cond : c.WeakTypeTag[Cond], msg : c.WeakTypeTag[Msg]
