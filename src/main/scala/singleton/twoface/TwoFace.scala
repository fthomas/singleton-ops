...
object TwoFace {
  ...
  final class Char[T] private(val value : scala.Char) extends AnyVal with TwoFaceAny[scala.Char, T] {
    def + [R](r : Char[R])(implicit tfo : TwoFaceOp[Int, scala.Int, T + R]) = tfo(this.getValue + r.getValue)
    def - [R](r : Char[R])(implicit tfo : TwoFaceOp[Int, scala.Int, T - R]) = tfo(this.getValue - r.getValue)
    def * [R](r : Char[R])(implicit tfo : TwoFaceOp[Int, scala.Int, T * R]) = tfo(this.getValue * r.getValue)
    def / [R](r : Char[R])(implicit tfo : TwoFaceOp[Int, scala.Int, T / R]) = tfo(this.getValue / r.getValue)
    def + [R](r : Int[R])(implicit tfo : TwoFaceOp[Int, scala.Int, T + R]) = tfo(this.getValue + r.getValue)
    def - [R](r : Int[R])(implicit tfo : TwoFaceOp[Int, scala.Int, T - R]) = tfo(this.getValue - r.getValue)
    def * [R](r : Int[R])(implicit tfo : TwoFaceOp[Int, scala.Int, T * R]) = tfo(this.getValue * r.getValue)
    def / [R](r : Int[R])(implicit tfo : TwoFaceOp[Int, scala.Int, T / R]) = tfo(this.getValue / r.getValue)
